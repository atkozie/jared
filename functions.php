...
function xylus_scripts(){
    ...
    wp_enqueue_script('hoverERM',  get_template_directory_uri() .'/js/hoverERM.js', ['jquery'], null, true);

    wp_enqueue_script('responsive_menu',  get_template_directory_uri() .'/js/responsive-menu.js', ['jquery'], null, true);
...
if( ! function_exists('xylus_comment_form') ){
    ...
    <div class="alert alert-danger must-log-in">'
                ...
                . sprintf( __( 'You must be <a href="%s">logged in</a> to post a comment.', 'xylus' ), wp_login_url( apply_filters( 'the_permalink', get_permalink( $post_id ) ) ) )
            ...
            'comment_notes_after'  => '<div class="form-allowed-tags comment-rules">' . sprintf( __( 'Comments may include the following <abbr title="HyperText Markup Language">HTML</abbr> tags and attributes: %s', 'xylus' ), ' <code>' . allowed_tags() . '</code>' ) . '</div>',
            ...
            <div class="pager">
                ...
                <?php if ( $previous ) { ?>
                    ...
                    <li class="previous">
                        ...
                        <?php previous_post_link( '%link', _x( '<i class="icon-long-arrow-left"></i> %title', 'Previous post link', 'xylus' ) ); ?>
                ...
                <?php if ( $next ) { ?>
                    ...
                    <li class="next"><?php next_post_link( '%link', _x( '%title <i class="icon-long-arrow-right"></i>', 'Next post link', 'xylus' ) ); ?></li>
